// show each testimonial for 10 sec then switch to the next one

// node list of testimonials

// loop through the and set time out for 5 sec , then on to next
...
// array object of the testimonials
const testimonials = [
  {
    name: "Miyah Myles",
    position: "Marketing",
...
// loop through the testimonials ever 10 sec
let idx = 1;
function updateTestimonial() {
  // doing some destructuring here
